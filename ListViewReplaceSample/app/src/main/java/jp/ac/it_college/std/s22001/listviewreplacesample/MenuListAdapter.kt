...
import jp.ac.it_college.std.s22001.listviewreplacesample.databinding.MenuRowBinding
...
class MenuListAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        // LayoutInflater のインスタンスがあれは、Bindingクラスをinflateできるようになる
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
       ...
       // ViewHolder の　binding を経由して、表示に関する処理をする。
        ...
        holder.binding.root.setOnClickListener {
            ...
            // 間接的に参照する。
            // getString メソッドで、文字列の置き換えマーカー(書式設定文字列)に値を埋め込める。
